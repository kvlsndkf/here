        ...
        <?php
            ...
            ?>
                <ul class="pagination justify-content-center pt-4">
                    ...
                    if ($back_page != 0) { ?>
                        <li class="page-item ">
                            <a class="page-link" href="list-team.page.php?page=<?php echo $back_page; ?>">Anterior</a>
                        </li>
                    <?php  } else { ?>
                    ...
                    for ($i = 1; $i < $qnt_page + 1; $i++) {  ?>
                        <li class="page-item">
                            <a class="page-link" href="list-team.page.php?page=<?php echo $i; ?>"><?php echo '<div class="pagination-style">'. $i .'</div>'?></a>
                        </li>
                    <?php } ?>
                    ...
                    if ($next_page <= $qnt_page) { ?>
                        <li class="page-item ">
                            <a class="page-link" href="list-team.page.php?page=<?php echo $next_page; ?>">Próximo</a>
                        </li>
                    <?php  } else { ?>
                        <li class="page-item disabled">
