...
<html lang="pt-br">
    <head>
        ...
        <link rel="shortcut icon" href="./views/images/favicon-16x16.png" type="image/x-icon">
        ...
        <script type="text/javascript" src="./views/scripts/index.scripts.js"></script>
        <title>HERE!</title>
    </head>
    <body>
        <header>
            ...
            <ul>
                ...
                <li><a href="#"></a>Comunidade</li>
            </ul>
        </header>
        <div class="part-1">
            <div class="left-1">
                <p class="title-1">Aprenda melhor juntos</p>
                <p class="text-1">Uma plataforma que facilitará a comunicação entre aluno e professor.</p>
                <input type="button" value="Entrar" class="btnEntrar-1">
            </div>
            <div class="right-1">
                <img src="./views/images/img1.svg" class="image-1">
            </div>   
        </div>
    </body>
</html>